...
# --- Calculate the average PSNR --- #
    ...
    print("ssim variance:"+ str(statistics.variance(ssim_list, xbar=None)))
    print("psnr variance:"+ str(statistics.variance(psnr_list, xbar=None)))

    return avr_psnr, avr_ssim

def get_value(net, val_data_loader, device, exp_name, save_tag=False):
