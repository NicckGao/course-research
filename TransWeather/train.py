...
from transweather_model_v import Transweather
...
labeled_name = 'all_weather.txt'

### The following files should be placed inside the directory "./data/test/"

# val_filename = 'val_list_rain800.txt'
val_filename1 = 'all_weather.txt'
# val_filename2 = 'test1.txt'

# --- Load training data and validation/test data --- #
lbl_train_data_loader = DataLoader(TrainData(crop_size, train_data_dir,labeled_name), batch_size=train_batch_size, shuffle=True, num_workers=0)
...
#-------------------------------------------------------------------------------------------------------------
    ...
    print("Rain")
    # print(epoch+1, num_epochs, one_epoch_time, train_psnr)
